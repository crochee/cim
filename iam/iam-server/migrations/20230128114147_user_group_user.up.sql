...
CREATE TABLE `user_group_user` (
    ...
    PRIMARY KEY (`id`),
    UNIQUE `idx_user_group_id_user_id_deleted` (`user_group_id`, `user_id`, `deleted`) USING BTREE,
    INDEX `idx_deleted` (`deleted`) USING BTREE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = 'user_group_user info';