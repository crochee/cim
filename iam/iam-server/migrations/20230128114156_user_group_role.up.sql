...
CREATE TABLE `user_group_role` (
    ...
    `user_group_id` VARCHAR(255) NOT NULL COMMENT 'user_group id',
    ...
    PRIMARY KEY (`id`),
    UNIQUE `idx_user_group_id_role_id_deleted` (`user_group_id`, `role_id`, `deleted`) USING BTREE,
    INDEX `idx_deleted` (`deleted`) USING BTREE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = 'user_group_role info';